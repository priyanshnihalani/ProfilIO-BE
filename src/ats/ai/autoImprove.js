...
3. Rewrite the Experience bullets:
   ...
   - Replace weak passive verbs (e.g., 'helped', 'worked on') with strong action verbs ('engineered', 'spearheaded', 'led', 'managed'). Every bullet MUST start immediately with a strong action verb (no adverbs like 'Successfully'). CRITICAL: Do NOT repeat the same action verb at the beginning of multiple bullet points. Use a wide, diverse variety of active verbs.
